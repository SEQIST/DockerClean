...
export default function BreadCrumb() {
  return (
    <div>
      <PageMeta
        title="React.js Breadcrumb Dashboard | SEQ.IST Demonstrator - React.js Admin Dashboard Template"
        description="This is React.js Breadcrumb Dashboard page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
