...
export default function Cards() {
  return (
    <>
      <PageMeta
        title="React.js Cards Dashboard | SEQ.IST Demonstrator - React.js Admin Dashboard Template"
        description="This is React.js Cards Dashboard page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
