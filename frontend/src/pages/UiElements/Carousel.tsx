...
export default function Carousel() {
  return (
    <>
      <PageMeta
        title="React.js Carousel Dashboard | SEQ.IST Demonstrator - React.js Admin Dashboard Template"
        description="This is React.js Carousel Dashboard page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
