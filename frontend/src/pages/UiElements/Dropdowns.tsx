...
export default function Dropdowns() {
  return (
    <div>
      <PageMeta
        title="React.js Dropdowns Dashboard | SEQ.IST Demonstrator - React.js Admin Dashboard Template"
        description="This is React.js Dropdowns Dashboard page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
