...
export default function Notifications() {
  ...
  return (
    <>
      <PageMeta
        title="React.js  Notifications | SEQ.IST Demonstrator - React.js Admin Dashboard Template"
        description="This is React.js Notifications  page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
