...
export default function Faqs() {
  return (
    <>
      <PageMeta
        title="React.js Faqs Dashboard | SEQ.IST Demonstrator - Next.js Admin Dashboard Template"
        description="This is React.js Faqs Dashboard page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
