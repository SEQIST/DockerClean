...
export default function EmailDetails() {
  return (
    <>
      <PageMeta
        title="React.js Inbox Dashboard | SEQ.IST Demonstrator - React.js Admin Dashboard Template"
        description="This is React.js Inbox Dashboard page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
