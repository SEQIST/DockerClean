...
export default function DataTables() {
  return (
    <>
      <PageMeta
        title="React.js Data Tables Dashboard | SEQ.IST Demonstrator - Next.js Admin Dashboard Template"
        description="This is React.js Data Tables Dashboard page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
