...
export default function BasicTables() {
  return (
    <>
      <PageMeta
        title="React.js Basic Tables Dashboard | SEQ.IST Demonstrator - Next.js Admin Dashboard Template"
        description="This is React.js Basic Tables Dashboard page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
