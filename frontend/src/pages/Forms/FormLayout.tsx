...
export default function FormLayout() {
  return (
    <div>
      <PageMeta
        title="React.js Form Layout Dashboard | SEQ.IST Demonstrator - React.js Admin Dashboard Template"
        description="This is React.js Form Layout  Dashboard page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
