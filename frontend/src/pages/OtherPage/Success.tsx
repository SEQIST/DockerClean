...
export default function Success() {
  return (
    <>
      <PageMeta
        title="React.js Success Dashboard | SEQ.IST Demonstrator - React.js Admin Dashboard Template"
        description="This is React.js Success Dashboard page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
