...
export default function ComingSoon() {
  ...
  return (
    <>
      <PageMeta
        title="React.js Coming Soon Dashboard | SEQ.IST Demonstrator - React.js Admin Dashboard Template"
        description="This is React.js Coming Soon  Dashboard page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
