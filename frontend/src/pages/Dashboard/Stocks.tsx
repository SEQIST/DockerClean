...
export default function Stocks() {
  return (
    <>
      <PageMeta
        title="React.js Stocks Dashboard | SEQ.IST Demonstrator - React.js Admin Dashboard Template"
        description="This is React.js Stocks Dashboard page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
