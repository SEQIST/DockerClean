...
export default function Analytics() {
  return (
    <>
      <PageMeta
        title="React.js Analytics Dashboard | SEQ.IST Demonstrator - React.js Admin Dashboard Template"
        description="This is React.js Analytics Dashboard page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
