...
export default function Crm() {
  return (
    <>
      <PageMeta
        title="React.js CRM Dashboard | SEQ.IST Demonstrator - React.js Admin Dashboard Template"
        description="This is React.js CRM Dashboard page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
