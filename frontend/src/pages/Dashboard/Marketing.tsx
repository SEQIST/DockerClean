...
export default function Marketing() {
  return (
    <>
      <PageMeta
        title="React.js Marketing Dashboard | SEQ.IST Demonstrator - React.js Admin Dashboard Template"
        description="This is React.js Marketing Dashboard page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
