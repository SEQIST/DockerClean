...
export default function PricingTables() {
  return (
    <div>
      <PageMeta
        title="React.js Pricing Dashboard | SEQ.IST Demonstrator - Next.js Admin Dashboard Template"
        description="This is React.js Pricing Dashboard page for SEQ.IST Demonstrator - React.js Tailwind CSS Admin Dashboard Template"
      />
