...
interface RiskFormProps {
  ...
  setFormData: React.Dispatch<React.SetStateAction<RiskFormProps['formData']>>;
  categories: { _id: string; name: string }[];
  strategies: { _id: string; name: string }[];
  workProducts: WorkProduct[];
  navigate: (path: string) => void;
  setError: React.Dispatch<React.SetStateAction<string | null>>;
  riskId?: string;
  onSubmit?: (data: RiskFormProps['formData']) => void;
  onCancel?: () => void;
}
...
const RiskForm = ({
  ...
  const handleSubmit = async () => {
    try {
      const requiredFields: (keyof typeof formData)[] = ['title', 'description'];
      ...
      const cleanedData = {
        ...
        workProducts: formData.workProducts || [],
        likelihoodBefore: formData.likelihoodBefore || 1,
        severityBeforeEstimated: formData.severityBeforeEstimated || 1,
        severityBeforeCalculated: formData.severityBeforeCalculated || 1,
        likelihoodAfter: formData.likelihoodAfter || 1,
        severityAfterEstimated: formData.severityAfterEstimated || 1,
        severityAfterCalculated: formData.severityAfterCalculated || 1,
      };

      if (riskId) {
        const url = `http://localhost:5001/api/riskmatrix/risks/${riskId}`;
        ...
        if (!response.ok) {
          ...
          throw new Error(errorData.message || 'Fehler beim Speichern des Risikos');
        }
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <input
            ...
            value={formData.likelihoodBefore || 1}
            onChange={handleChange}
            min="1"
            max="5"
            className="w-full p-2 text-sm text-gray-800 dark:text-white bg-transparent border border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-800"
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <input
            ...
            value={formData.severityBeforeEstimated || 1}
            onChange={handleChange}
            min="1"
            max="5"
            className="w-full p-2 text-sm text-gray-800 dark:text-white bg-transparent border border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-800"
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <input
            ...
            value={formData.severityBeforeCalculated || 1}
            onChange={handleChange}
            min="1"
            max="5"
            className="w-full p-2 text-sm text-gray-800 dark:text-white bg-transparent border border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-800"
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <input
            ...
            value={formData.likelihoodAfter || 1}
            onChange={handleChange}
            min="1"
            max="5"
            className="w-full p-2 text-sm text-gray-800 dark:text-white bg-transparent border border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-800"
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <input
            ...
            value={formData.severityAfterEstimated || 1}
            onChange={handleChange}
            min="1"
            max="5"
            className="w-full p-2 text-sm text-gray-800 dark:text-white bg-transparent border border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-800"
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <input
            ...
            value={formData.severityAfterCalculated || 1}
            onChange={handleChange}
            min="1"
            max="5"
            className="w-full p-2 text-sm text-gray-800 dark:text-white bg-transparent border border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-800"
