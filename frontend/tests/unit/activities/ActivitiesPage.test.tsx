// src/features/activities/pages/__tests__/ActivitiesPage.test.tsx
import React from 'react';
import { render, screen, fireEvent, waitFor } from '@testing-library/react';
import { MemoryRouter } from 'react-router-dom';
import { setupServer } from 'msw/node';
import { http, HttpResponse } from 'msw'; // Neue Syntax für MSW ab Version 1.0.0
...
const server = setupServer(
  http.get('http://localhost:5001/api/activities', () => {
    return HttpResponse.json([
      { _id: '1', name: 'Activity 1', abbreviation: 'A1', process: 'proc1', result: 'wp1', trigger: { workProducts: [] } },
      { _id: '2', name: 'Activity 2', abbreviation: 'A2', process: 'proc2', result: 'wp2', trigger: { workProducts: [] } },
    ]);
  }),
  ...
  http.get('http://localhost:5001/api/workproducts', () => {
    return HttpResponse.json([
      { _id: 'wp1', name: 'Work Product 1' },
      { _id: 'wp2', name: 'Work Product 2' },
    ]);
  }),
